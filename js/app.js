...
const TRANSLATIONS = {
    en: {
        ...
        mealsDesc: 'Set of all meals served during the entire event',
    ...
    fr: {
        ...
        mealsDesc: 'Ensemble des repas servis pendant toute la durée du congrès',
        ...
        yearVegetarian: 'Une année de régime végétarien',
...
function getPerspectiveScenarios() {
    return [
        ...
        {
            key: 'yearVegetarian',
            label: t('yearVegetarian'),
            value: 2.5 * 365 * MEAL_FACTORS.vegetarian,
            color: CATEGORY_COLORS.vegetarian,
        },
        {
            key: 'yearVegan',
            label: t('yearVegan'),
